...
with open("llama_bbh_correct.json", "w") as f:
...
with open("llama_bbh_results.json", "w") as f:
    json.dump(summary, f, indent=2)
print(f"Llama BBH: {correct} correct out of {attempts} attempts (accuracy={accuracy:.3f})")
print("Correct answers saved to llama_bbh_correct.json")
print("Full results saved to llama_bbh_results.json")
