...
23--33. The activation analysis is diagnostic rather than causal: it localizes a
residual-stream correlate of the social manipulation, but does not establish a
steering direction for conformity.
\end{abstract}
...
answer. We measure accuracy, parseability, and conformity to the repeated wrong
peer answer under group sizes
...
is therefore an empirical localization, projection, and layer-wise cosine
analysis of a social pressure manipulation, paired with behavioral mitigations
...
so both can miss token-local mechanisms or more distributed representations. We
also do not perform activation patching or steering interventions here; causal
claims about the direction would require those experiments.
