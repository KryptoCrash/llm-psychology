...
from BBH. Each item was selected from saved no-social-context screening runs, so
the experiment measures susceptibility to
...
These intervals quantify uncertainty over stimulus items conditional on the saved
generations and peer-answer assignments; they do not capture decoding-seed
variability.
