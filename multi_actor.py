...
def run_experiment(model_name, dataset, mode, explain=False, model=None, device=None, output_file=None):
...
def main():
    ...
    run_experiment(args.model, args.dataset, args.mode, args.explain)
